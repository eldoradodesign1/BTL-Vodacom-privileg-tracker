...
type PosFilter = 'all' | 'pending' | 'active' | 'inactive' | 'completed';
...
export const MerchantSupervisorView: React.FC<MerchantSupervisorViewProps> = () => {
  ...
  const inventoryCounts = useMemo(() => {
    ...
    const statuses: Record<PosFilter, number> = { all: controls.length, pending: 0, active: 0, inactive: 0, completed: 0 };
