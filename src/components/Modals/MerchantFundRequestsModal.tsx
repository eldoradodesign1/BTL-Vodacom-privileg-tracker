...
import { Banknote, BarChart3, Search, X } from 'lucide-react';
...
export const MerchantFundRequestsModal: React.FC<MerchantFundRequestsModalProps> = ({ isOpen, requests, onClose, onOpenReport, onSelect }) => {
