import{r as n,j as e,X as w,F as N,a3 as U,a4 as R,a5 as D,a6 as v,p as O,$ as E,T as L}from"./vendor-react-ckYWaETz.js";import{I as b,J as T,h as P,K as I,L as B,M as J,s as M,N as G}from"./index-SO475GyM.js";import"./vendor-supabase-CG6S1lgy.js";async function F(){if(!b())return{ok:!1,message:"Configuration Supabase absente. Ajoutez VITE_SUPABASE_URL et VITE_SUPABASE_ANON_KEY."};try{return{ok:!0,message:"Migration Supabase terminée.",summary:await T()}}catch(o){return{ok:!1,message:o instanceof Error?o.message:"Échec de la migration."}}}const z=({isOpen:o,onClose:j,onSyncSuccess:f})=>{const[s,h]=n.useState(P()),[c,i]=n.useState(!1),[d,r]=n.useState(null),[y,S]=n.useState(!1),[m,x]=n.useState(null),p=n.useRef(null);if(!o)return null;const k=async()=>{if(i(!0),r(null),J(s),s.sheetCsvUrl){const t=await M(s.sheetCsvUrl,{strictUsers:!0});t.success?(r({type:"success",text:t.message}),f()):r({type:"error",text:t.message})}else r({type:"success",text:"Paramètres Google Sheets enregistrés avec succès."});i(!1)},C=async t=>{var l;const u=(l=t.target.files)==null?void 0:l[0];if(u){i(!0),r(null);try{const a=await u.arrayBuffer(),g=await B(a,{strictUsers:!0});g.success?(r({type:"success",text:g.message}),f()):r({type:"error",text:g.message})}catch(a){r({type:"error",text:`Erreur de lecture du fichier : ${a.message||a}`})}finally{i(!1),p.current&&(p.current.value="")}}},_=()=>{const t=G(),u=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(u),a=document.createElement("a");a.href=l,a.download=`Vodacom_Base_Donnees_GSheet_${new Date().toISOString().split("T")[0]}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(l)},A=async()=>{S(!0),x(null);try{const t=await F();x({type:t.ok?"success":"error",text:t.message+(t.summary?` (${JSON.stringify(t.summary)})`:"")})}catch(t){x({type:"error",text:(t==null?void 0:t.message)||"Échec de la migration"})}finally{S(!1)}};return e.jsx("div",{className:"fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 animate-pop",children:e.jsxs("div",{className:"modal-sheet relative w-full max-w-lg max-h-[90vh] overflow-y-auto",children:[e.jsx("div",{className:"modal-handle"}),e.jsx("button",{onClick:j,className:"absolute top-6 right-6 text-gray-400 hover:text-white p-2 rounded-full hover:bg-white/10",children:e.jsx(w,{className:"w-5 h-5"})}),e.jsxs("div",{className:"flex items-center space-x-3 mb-6",children:[e.jsx("div",{className:"p-3 bg-emerald-500/20 text-emerald-400 rounded-2xl border border-emerald-500/30",children:e.jsx(N,{className:"w-6 h-6"})}),e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black uppercase text-white tracking-wider",children:["Import & Synchro ",e.jsx("span",{className:"text-emerald-400",children:"Multi-Onglets"})]}),e.jsx("p",{className:"text-xs text-gray-400 font-semibold mt-0.5",children:"Chargement direct Fichier Excel (.xlsx) ou Lien Google Sheets"})]})]}),d&&e.jsxs("div",{className:`p-3.5 rounded-2xl border mb-4 text-xs font-bold flex items-center space-x-2 ${d.type==="success"?"bg-emerald-500/10 border-emerald-500/30 text-emerald-400":"bg-red-500/10 border-red-500/30 text-red-400"}`,children:[d.type==="success"?e.jsx(U,{className:"w-4 h-4 shrink-0"}):e.jsx(w,{className:"w-4 h-4 shrink-0"}),e.jsx("span",{children:d.text})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl",children:[e.jsxs("label",{className:"text-xs font-black uppercase text-emerald-400 block mb-2 flex items-center space-x-2",children:[e.jsx(R,{className:"w-4 h-4"}),e.jsx("span",{children:"Importer un Fichier Excel complet (.xlsx)"})]}),e.jsx("p",{className:"text-[11px] text-gray-300 mb-3",children:"Permet de parcourir et charger automatiquement tous les onglets (Users, Shops, Leads, DailyReports) à partir d'un fichier Excel."}),e.jsx("input",{type:"file",ref:p,accept:".xlsx,.xls,.csv",onChange:C,className:"hidden"}),e.jsxs("button",{onClick:()=>{var t;return(t=p.current)==null?void 0:t.click()},disabled:c,className:"w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-black uppercase text-xs rounded-xl flex items-center justify-center space-x-2 shadow-lg transition-all",children:[e.jsx(N,{className:"w-4 h-4"}),e.jsx("span",{children:c?"Traitement du fichier...":"Sélectionner Fichier .XLSX / .CSV"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[10px] font-black uppercase text-gray-400 block mb-1",children:"Ou Lien Google Sheets Publié (Import Web)"}),e.jsxs("div",{className:"relative",children:[e.jsx(D,{className:"w-4 h-4 text-gray-500 absolute left-3 top-3"}),e.jsx("input",{type:"url",value:s.sheetCsvUrl,onChange:t=>h({...s,sheetCsvUrl:t.target.value}),placeholder:"https://docs.google.com/spreadsheets/d/e/.../pub?output=csv",className:"w-full bg-black/60 border border-white/10 rounded-2xl pl-9 pr-3 py-2.5 text-xs text-white font-bold focus:outline-none focus:border-emerald-500"})]}),e.jsxs("p",{className:"text-[10px] text-gray-500 mt-1",children:["Dans Google Sheets : ",e.jsx("b",{className:"text-gray-300",children:"Fichier > Partager > Publier sur le web"}),"."]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[10px] font-black uppercase text-gray-400 block mb-1",children:"URL Webhook Apps Script (Export temps réel)"}),e.jsx("input",{type:"url",value:s.webhookUrl,onChange:t=>h({...s,webhookUrl:t.target.value}),placeholder:"https://script.google.com/macros/s/.../exec",className:"w-full bg-black/60 border border-white/10 rounded-2xl px-3 py-2.5 text-xs text-white font-bold focus:outline-none focus:border-emerald-500"})]}),e.jsxs("div",{className:"p-3.5 bg-white/5 border border-white/10 rounded-2xl space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-black uppercase text-gray-300",children:"Auto-synchronisation en arrière-plan"}),e.jsx("input",{type:"checkbox",checked:s.autoSync,onChange:t=>h({...s,autoSync:t.target.checked}),className:"w-4 h-4 accent-emerald-500 rounded"})]}),s.lastSyncedAt&&e.jsxs("p",{className:"text-[10px] text-emerald-400 font-bold",children:["Dernière synchro : ",new Date(s.lastSyncedAt).toLocaleString("fr-FR")]})]}),e.jsxs("div",{className:"p-4 bg-violet-500/10 border border-violet-500/30 rounded-2xl",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-2",children:[e.jsx(v,{className:"w-4 h-4 text-violet-400"}),e.jsx("span",{className:"text-xs font-black uppercase text-violet-400",children:"Migration vers Supabase"})]}),e.jsx("p",{className:"text-[11px] text-gray-300 mb-3",children:"Copie les données locales vers Supabase (users, shops, checkins, leads, reports, notifications, chat). Les photos peuvent ensuite être stockées dans Supabase Storage."}),m&&e.jsx("div",{className:`p-2.5 rounded-xl border mb-3 text-[11px] font-bold ${m.type==="success"?"bg-emerald-500/10 border-emerald-500/30 text-emerald-400":"bg-red-500/10 border-red-500/30 text-red-400"}`,children:m.text}),e.jsxs("button",{onClick:A,disabled:y||!b(),className:"w-full py-2.5 bg-violet-500 hover:bg-violet-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-black uppercase text-xs rounded-xl flex items-center justify-center space-x-2 shadow-lg transition-all",children:[e.jsx(v,{className:"w-4 h-4"}),e.jsx("span",{children:y?"Migration en cours...":"Lancer la migration Supabase"})]}),!b()&&e.jsx("p",{className:"text-[10px] text-gray-400 mt-2",children:"Ajoutez VITE_SUPABASE_URL et VITE_SUPABASE_ANON_KEY dans votre environnement pour activer cette action."})]}),e.jsxs("details",{className:"p-3.5 bg-zinc-900 border border-white/10 rounded-2xl group",children:[e.jsxs("summary",{className:"text-xs font-black uppercase text-amber-400 cursor-pointer flex items-center justify-between",children:[e.jsx("span",{children:"📜 Code Google Apps Script (Webhook + Drive Photos)"}),e.jsx("span",{className:"text-[10px] text-gray-400 group-open:rotate-180 transition-transform",children:"▼"})]}),e.jsxs("div",{className:"mt-3 space-y-2 text-[11px] text-gray-300",children:[e.jsxs("p",{className:"font-semibold text-white",children:["Code ",e.jsx("code",{className:"text-amber-400 font-mono",children:"Code.gs"})," à coller dans Extensions > Apps Script :"]}),e.jsx("pre",{className:"p-3 bg-black/90 border border-white/10 rounded-xl text-[10px] text-emerald-300 overflow-x-auto select-all font-mono leading-relaxed",children:`function doPost(e) {
  try {
...
}`})]})]}),e.jsxs("div",{className:"pt-2 grid grid-cols-1 sm:grid-cols-2 gap-2",children:[e.jsxs("button",{onClick:k,disabled:c,className:"w-full py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-xs font-black uppercase flex items-center justify-center space-x-2 shadow-lg shadow-emerald-600/30 transition-all",children:[e.jsx(O,{className:`w-4 h-4 ${c?"animate-spin":""}`}),e.jsx("span",{children:c?"Connexion...":"Synchroniser URL GSheet"})]}),e.jsxs("button",{onClick:_,className:"w-full py-3 bg-white/10 hover:bg-white/20 text-white rounded-2xl text-xs font-black uppercase flex items-center justify-center space-x-2 transition-all border border-white/10",children:[e.jsx(E,{className:"w-4 h-4 text-emerald-400"}),e.jsx("span",{children:"Exporter Base CSV"})]})]}),e.jsx("div",{className:"pt-2 border-t border-white/10",children:e.jsxs("button",{onClick:()=>{window.confirm("Êtes-vous sûr de vouloir effectuer un reset complet ? Cela effacera toutes les données en cache et vous déconnectera.")&&(I(),window.location.reload())},className:"w-full py-3 bg-red-600/20 hover:bg-red-600/30 text-red-400 rounded-2xl text-xs font-black uppercase flex items-center justify-center space-x-2 transition-all border border-red-500/30",children:[e.jsx(L,{className:"w-4 h-4"}),e.jsx("span",{children:"Vider le Cache & Reset Total (Déconnexion)"})]})})]})]})})};export{z as GSheetModal};
