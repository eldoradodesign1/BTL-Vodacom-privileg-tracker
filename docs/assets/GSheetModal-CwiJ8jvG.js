import{m as h,Y as f,Z as U,r as n,k as D,j as e,X as N,F as v,T as O,_ as L,$ as E,a0 as M,s as T,a1 as P}from"./index-C75KY3wm.js";import{R as I}from"./refresh-cw-CKY8GtFN.js";import{D as B}from"./download-qnmjxDe6.js";/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const J=[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]],G=h("circle-check-big",J);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 15 21.84",key:"14ibmq"}],["path",{d:"M21 5V8",key:"1marbg"}],["path",{d:"M21 12L18 17H22L19 22",key:"zafso"}],["path",{d:"M3 12A9 3 0 0 0 14.59 14.87",key:"1y4wr8"}]],j=h("database-zap",F);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V=[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71",key:"1cjeqo"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",key:"19qd67"}]],$=h("link",V);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],W=h("upload",z);async function q(){if(!f())return{ok:!1,message:"Configuration Supabase absente. Ajoutez VITE_SUPABASE_URL et VITE_SUPABASE_ANON_KEY."};try{return{ok:!0,message:"Migration Supabase terminée.",summary:await U()}}catch(o){return{ok:!1,message:o instanceof Error?o.message:"Échec de la migration."}}}const K=({isOpen:o,onClose:k,onSyncSuccess:y})=>{const[s,m]=n.useState(D()),[c,i]=n.useState(!1),[d,r]=n.useState(null),[S,w]=n.useState(!1),[x,g]=n.useState(null),p=n.useRef(null);if(!o)return null;const _=async()=>{if(i(!0),r(null),M(s),s.sheetCsvUrl){const t=await T(s.sheetCsvUrl,{strictUsers:!0});t.success?(r({type:"success",text:t.message}),y()):r({type:"error",text:t.message})}else r({type:"success",text:"Paramètres Google Sheets enregistrés avec succès."});i(!1)},C=async t=>{var l;const u=(l=t.target.files)==null?void 0:l[0];if(u){i(!0),r(null);try{const a=await u.arrayBuffer(),b=await E(a,{strictUsers:!0});b.success?(r({type:"success",text:b.message}),y()):r({type:"error",text:b.message})}catch(a){r({type:"error",text:`Erreur de lecture du fichier : ${a.message||a}`})}finally{i(!1),p.current&&(p.current.value="")}}},A=()=>{const t=P(),u=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(u),a=document.createElement("a");a.href=l,a.download=`Vodacom_Base_Donnees_GSheet_${new Date().toISOString().split("T")[0]}.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(l)},R=async()=>{w(!0),g(null);try{const t=await q();g({type:t.ok?"success":"error",text:t.message+(t.summary?` (${JSON.stringify(t.summary)})`:"")})}catch(t){g({type:"error",text:(t==null?void 0:t.message)||"Échec de la migration"})}finally{w(!1)}};return e.jsx("div",{className:"fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 animate-pop",children:e.jsxs("div",{className:"modal-sheet relative w-full max-w-lg max-h-[90vh] overflow-y-auto",children:[e.jsx("div",{className:"modal-handle"}),e.jsx("button",{onClick:k,className:"absolute top-6 right-6 text-gray-400 hover:text-white p-2 rounded-full hover:bg-white/10",children:e.jsx(N,{className:"w-5 h-5"})}),e.jsxs("div",{className:"flex items-center space-x-3 mb-6",children:[e.jsx("div",{className:"p-3 bg-emerald-500/20 text-emerald-400 rounded-2xl border border-emerald-500/30",children:e.jsx(v,{className:"w-6 h-6"})}),e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-black uppercase text-white tracking-wider",children:["Import & Synchro ",e.jsx("span",{className:"text-emerald-400",children:"Multi-Onglets"})]}),e.jsx("p",{className:"text-xs text-gray-400 font-semibold mt-0.5",children:"Chargement direct Fichier Excel (.xlsx) ou Lien Google Sheets"})]})]}),d&&e.jsxs("div",{className:`p-3.5 rounded-2xl border mb-4 text-xs font-bold flex items-center space-x-2 ${d.type==="success"?"bg-emerald-500/10 border-emerald-500/30 text-emerald-400":"bg-red-500/10 border-red-500/30 text-red-400"}`,children:[d.type==="success"?e.jsx(G,{className:"w-4 h-4 shrink-0"}):e.jsx(N,{className:"w-4 h-4 shrink-0"}),e.jsx("span",{children:d.text})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl",children:[e.jsxs("label",{className:"text-xs font-black uppercase text-emerald-400 block mb-2 flex items-center space-x-2",children:[e.jsx(W,{className:"w-4 h-4"}),e.jsx("span",{children:"Importer un Fichier Excel complet (.xlsx)"})]}),e.jsx("p",{className:"text-[11px] text-gray-300 mb-3",children:"Permet de parcourir et charger automatiquement tous les onglets (Users, Shops, Leads, DailyReports) à partir d'un fichier Excel."}),e.jsx("input",{type:"file",ref:p,accept:".xlsx,.xls,.csv",onChange:C,className:"hidden"}),e.jsxs("button",{onClick:()=>{var t;return(t=p.current)==null?void 0:t.click()},disabled:c,className:"w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 text-black font-black uppercase text-xs rounded-xl flex items-center justify-center space-x-2 shadow-lg transition-all",children:[e.jsx(v,{className:"w-4 h-4"}),e.jsx("span",{children:c?"Traitement du fichier...":"Sélectionner Fichier .XLSX / .CSV"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[10px] font-black uppercase text-gray-400 block mb-1",children:"Ou Lien Google Sheets Publié (Import Web)"}),e.jsxs("div",{className:"relative",children:[e.jsx($,{className:"w-4 h-4 text-gray-500 absolute left-3 top-3"}),e.jsx("input",{type:"url",value:s.sheetCsvUrl,onChange:t=>m({...s,sheetCsvUrl:t.target.value}),placeholder:"https://docs.google.com/spreadsheets/d/e/.../pub?output=csv",className:"w-full bg-black/60 border border-white/10 rounded-2xl pl-9 pr-3 py-2.5 text-xs text-white font-bold focus:outline-none focus:border-emerald-500"})]}),e.jsxs("p",{className:"text-[10px] text-gray-500 mt-1",children:["Dans Google Sheets : ",e.jsx("b",{className:"text-gray-300",children:"Fichier > Partager > Publier sur le web"}),"."]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-[10px] font-black uppercase text-gray-400 block mb-1",children:"URL Webhook Apps Script (Export temps réel)"}),e.jsx("input",{type:"url",value:s.webhookUrl,onChange:t=>m({...s,webhookUrl:t.target.value}),placeholder:"https://script.google.com/macros/s/.../exec",className:"w-full bg-black/60 border border-white/10 rounded-2xl px-3 py-2.5 text-xs text-white font-bold focus:outline-none focus:border-emerald-500"})]}),e.jsxs("div",{className:"p-3.5 bg-white/5 border border-white/10 rounded-2xl space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"text-xs font-black uppercase text-gray-300",children:"Auto-synchronisation en arrière-plan"}),e.jsx("input",{type:"checkbox",checked:s.autoSync,onChange:t=>m({...s,autoSync:t.target.checked}),className:"w-4 h-4 accent-emerald-500 rounded"})]}),s.lastSyncedAt&&e.jsxs("p",{className:"text-[10px] text-emerald-400 font-bold",children:["Dernière synchro : ",new Date(s.lastSyncedAt).toLocaleString("fr-FR")]})]}),e.jsxs("div",{className:"p-4 bg-violet-500/10 border border-violet-500/30 rounded-2xl",children:[e.jsxs("div",{className:"flex items-center space-x-2 mb-2",children:[e.jsx(j,{className:"w-4 h-4 text-violet-400"}),e.jsx("span",{className:"text-xs font-black uppercase text-violet-400",children:"Migration vers Supabase"})]}),e.jsx("p",{className:"text-[11px] text-gray-300 mb-3",children:"Copie les données locales vers Supabase (users, shops, checkins, leads, reports, notifications, chat). Les photos peuvent ensuite être stockées dans Supabase Storage."}),x&&e.jsx("div",{className:`p-2.5 rounded-xl border mb-3 text-[11px] font-bold ${x.type==="success"?"bg-emerald-500/10 border-emerald-500/30 text-emerald-400":"bg-red-500/10 border-red-500/30 text-red-400"}`,children:x.text}),e.jsxs("button",{onClick:R,disabled:S||!f(),className:"w-full py-2.5 bg-violet-500 hover:bg-violet-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-black uppercase text-xs rounded-xl flex items-center justify-center space-x-2 shadow-lg transition-all",children:[e.jsx(j,{className:"w-4 h-4"}),e.jsx("span",{children:S?"Migration en cours...":"Lancer la migration Supabase"})]}),!f()&&e.jsx("p",{className:"text-[10px] text-gray-400 mt-2",children:"Ajoutez VITE_SUPABASE_URL et VITE_SUPABASE_ANON_KEY dans votre environnement pour activer cette action."})]}),e.jsxs("details",{className:"p-3.5 bg-zinc-900 border border-white/10 rounded-2xl group",children:[e.jsxs("summary",{className:"text-xs font-black uppercase text-amber-400 cursor-pointer flex items-center justify-between",children:[e.jsx("span",{children:"📜 Code Google Apps Script (Webhook + Drive Photos)"}),e.jsx("span",{className:"text-[10px] text-gray-400 group-open:rotate-180 transition-transform",children:"▼"})]}),e.jsxs("div",{className:"mt-3 space-y-2 text-[11px] text-gray-300",children:[e.jsxs("p",{className:"font-semibold text-white",children:["Code ",e.jsx("code",{className:"text-amber-400 font-mono",children:"Code.gs"})," à coller dans Extensions > Apps Script :"]}),e.jsx("pre",{className:"p-3 bg-black/90 border border-white/10 rounded-xl text-[10px] text-emerald-300 overflow-x-auto select-all font-mono leading-relaxed",children:`function doPost(e) {
  try {
